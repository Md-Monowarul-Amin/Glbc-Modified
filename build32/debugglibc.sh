...
BUILD_DIR="/home/saraj/Desktop/glibc_modified/build32/"
CMD_FILE="/home/saraj/Desktop/glibc_modified/build32/debugglibc.gdb"
CONTAINER=false
DIRECT=true
STATIC=false
SYMBOLSFILE=true
...
WAIT_FOR_DEBUGGER=1 /home/saraj/Desktop/glibc_modified/build32/testrun.sh --tool=container ${TESTCASE} &
gdb -x ${TESTCASE}.gdb
elif [ "$STATIC" == true ]
then
gdb ${TESTCASE}
