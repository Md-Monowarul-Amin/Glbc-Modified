...
#define GCCMACRO__pentiumpro__ 1
...
#define GCCMACRO__SIZEOF_FLOAT80__ 12
...
#define GCCMACRO__WCHAR_MAX__ 0x7fffffffL
...
#define GCCMACRO__FLT_EVAL_METHOD__ 2
...
#define GCCMACRO__LAHF_SAHF__ 1
...
#define GCCMACRO__SIZEOF_LONG_DOUBLE__ 12
...
#define GCCMACRONO_HIDDEN_EXTERN_FUNC_IN_PIE 1
...
#define GCCMACRO__ifunc_args(type_name,name,expr,init,...) extern __typeof (type_name) name __attribute__ ((ifunc (#name "_ifunc"))); __ifunc_resolver (type_name, name, expr, init, static, __VA_ARGS__)
...
#define GCCMACRO__code_model_32__ 1
...
#define GCCMACRO__WCHAR_TYPE__ long int
...
#define GCCMACROMINIMUM_X86_ISA_LEVEL 0
